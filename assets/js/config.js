...
export const CONFIG = {
  ...
  // ФОНОВАЯ МУЗЫКА. Ссылка на что угодно из:
  //   Spotify      плейлист, альбом, трек. Гостям играют только отрывки,
  //                целиком слышат лишь те, у кого есть подписка
  //   YouTube      видео или плейлист, играет целиком у всех
  //   SoundCloud   трек или сет, играет целиком у всех
  //   свой файл    'assets/audio/mix.mp3', если музыка твоя собственная
  //
  // Пустое поле — блока на странице нет. Проигрыватель встраивается
  // только после нажатия: чужой кадр тянет свои куки, да и автозапуск
  // браузеры всё равно блокируют.
  player: {
