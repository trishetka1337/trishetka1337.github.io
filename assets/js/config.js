...
export const CONFIG = {
  ...
  now: {
    updated: '2026-09-05',
    lines: [
      'Собираю эту страницу: живые данные, спутники над головой, никакого бэкенда.',
      'Держу свои сервисы на своих серверах: почта, облако, VPN.',
      'Пишу на Flutter два приложения для управления серверами с телефона.',
      'Учусь делать музыку в FL Studio.',
    ],
  },
